...
export type TMDBMovieSearchResultDTO = z.infer<typeof TMDBMovieSearchResultDTOSchema>
...
>;
export type TMDBReleaseDatesDTO = z.infer<
  typeof TMDBReleaseDatesDTOSchema
>;